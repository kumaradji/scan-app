  ...
  return (
    <section className={styles.businessTariffCard}>
      ...
      <div
        ...
        onMouseUp={onMouseUp}
      >
        <div className={styles.businessTariffCard__moreText}>Подробнее</div>
      </div>

      <div className={styles.businessTariffCard__priceTitle}>
        <div className={styles.businessTariffCard__infoText}>
          <span className={styles.businessTariffCard__price}>2 379 ₽</span>
          <span className={styles.businessTariffCard__priceHigh}>3 700 ₽</span>
        </div>
      </div>

      <img
        className={styles.businessTariffCard__tariffItemsList}
        src={ItemsList}
        alt="ItenmsList"
      />
    </section>
